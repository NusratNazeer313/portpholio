...
const Projects = () => {
  return (
    <div className="w-full h-auto flex flex-col items-center justify-center pb-20 bg-slate-100 px-4">
      ...
      <div className="w-full ">
        <div className="grid xs:grid-cols-1 sm:grid-cols-2 md:grid-cols-2  lg:grid-cols-3 gap-4 p-4">
